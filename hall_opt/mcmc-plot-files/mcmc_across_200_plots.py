...
# Paths 
base_results_dir = os.path.join("..", "mcmc-results-2")
plots_dir = os.path.join(base_results_dir, "plots-2")
...
def load_data():
    ...
    samples_path = os.path.join(base_results_dir, "final_mcmc_samples.csv")
    truth_data_path = os.path.join(base_results_dir, "mcmc_observed_data_map.json")
    pre_mcmc_data_path = os.path.join(base_results_dir, "mcmc_pre_mcmc_initial.json") #metrics from MAP resutls
    initial_params_path = os.path.join("..", "results-Nelder-Mead", "best_initial_guess_w_2_0.json") #map parameters
