...
for ion_velocity in ion_velocity_values:
    plt.plot(z_normalized, ion_velocity, alpha=0.5, color="purple", linestyle="-")
    
plt.plot([], [], color="purple", linestyle="-", alpha=0.5, label="Ion Velocity MCMC Samples")



    

# Calculate and plot mean ion velocity across N iterations
