...
# def generate_mcmc_iteration_metric_plots(settings: Settings, iter_metrics_dir: Path, save_dir: Path):
...
# plt.grid(True)
# plt.tight_layout()
# thrust_histogram_path = save_dir / "thrust_histogram.png"
# plt.savefig(thrust_histogram_path)
# plt.close()
...
# plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "ion_velocity_predictions.png"))
# plt.close()
