...
def plot_comparison_with_error_and_truth(z_normalized, posterior_prediction, observed_data, initial_data):
    ...
    plot_path = os.path.join(
        "..", "neldermead/mcmc-plots", "comparison_with_corrected_error_bands_y_points.png"
    )
...
def plot_comparison_with_subplot(z_normalized, observed_data, initial_data, posterior_prediction):
    ...
    plt.tight_layout()
    plot_path = os.path.join(
        "..", "neldermead/mcmc-plots", "comparison_subplot_corrected_error_bands.png"
    )
    plt.savefig(plot_path)
    print(f"Plot saved to {plot_path}.")
    plt.show()
...
def plot_comparison_with_corrected_error(
    ...
    plt.tight_layout()
    plot_path = os.path.join(
        "..", "neldermead/mcmc-plots", "comparison_corrected_error_bands.png"
    )
    plt.savefig(plot_path)
    print(f"Plot saved to {plot_path}.")
    plt.show()
...
def plot_combined_corrected_error_bands(
    ...
    # Save the plot
    plot_path = os.path.join(
        "..", "neldermead/mcmc-plots", "combined_comparison_corrected_error_bands.png"
    )
    plt.savefig(plot_path)
    print(f"Plot saved to {plot_path}.")
    plt.show()
...
def main():
    ...
    # File paths
    samples_path = os.path.join("..", "results-mcmc", "final_mcmc_samples_w_2.0_16.csv")
    initial_simulation_path = os.path.join("..", "results-mcmc", "mcmc_w_2.0_initial_mcmc.json")
    observed_data_path = os.path.join("..", "results-mcmc", "mcmc_w_2.0_observed_data_map.json")
    ...
    posterior_filename = os.path.join("..", "results-mcmc", "posterior_prediction_last_sample.json")
